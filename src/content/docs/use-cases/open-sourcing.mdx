...
<Aside type="caution">Always verify no sensitive content is exported:</Aside>
...
See [Importing Contributions](/use-cases/importing/) for the reverse workflow.

## Next Steps

- [Importing contributions](/use-cases/importing/)
