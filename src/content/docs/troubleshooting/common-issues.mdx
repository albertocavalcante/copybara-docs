...
| --------------------------- | ---------------------------------------- |
| `No changes to migrate`     | [No changes](#no-changes-to-migrate)     |
| `Authentication failed`     | [Auth issues](#authentication-failed)    |
| `Permission denied`         | [Permissions](#permission-denied)        |
| `Unknown field`             | [Config errors](#unknown-field)          |
| `Missing required field`    | [Config errors](#missing-required-field) |
| `Invalid glob pattern`      | [Glob errors](#invalid-glob-pattern)     |
| `GitOrigin-RevId not found` | [State issues](#missing-gitorigin-revid) |
| `Pattern not found`         | [Transform errors](#pattern-not-found)   |
| `verify_match failed`       | [Verification](#verify_match-failed)     |
| `OutOfMemoryError`          | [Memory issues](#memory-issues)          |
| `Branch already exists`     | [PR issues](#branch-already-exists)      |
| `rate limit exceeded`       | [Rate limiting](#rate-limiting)          |
