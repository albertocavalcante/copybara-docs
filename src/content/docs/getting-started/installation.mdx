...
```bash
alias copybara='java -jar /path/to/copybara_deploy.jar'
```
</Aside>
...
<Aside type="note">
The official Docker image may lag behind releases. For the latest version, consider building your own image.
</Aside>
...
- [Core concepts](/copybara-docs/getting-started/concepts/)
- [Workflow modes](/copybara-docs/workflows/overview/)
