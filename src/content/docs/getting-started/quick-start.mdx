...
<Aside type="tip">
Always validate before running to catch syntax errors and configuration issues.
</Aside>
...
<Aside type="note">
See [CHANGE_REQUEST mode](/copybara-docs/workflows/change-request/) for detailed PR workflow documentation.
</Aside>
...
- [Learn about workflow modes](/copybara-docs/workflows/modes/)
- [Explore transformations](/copybara-docs/transformations/overview/)
- [Set up GitHub Actions](/copybara-docs/cicd/github-actions/)
