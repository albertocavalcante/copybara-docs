...
<Aside type="tip" title="New to these tools?">
  This documentation references tools like
  [Gerrit](https://www.gerritcodereview.com/),
  [Starlark](https://github.com/bazelbuild/starlark), and concepts like CLs
  (Change Lists) and PRs (Pull Requests). If you're unfamiliar with any
  terminology, check the [Glossary](/reference/glossary/) for definitions and
  links to learn more.
</Aside>
...
- [Workflow modes in depth](/workflows/modes/)
- [All transformation types](/transformations/overview/)
