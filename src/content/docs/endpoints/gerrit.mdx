...
<Aside type="note" title="What is Gerrit?">
  [Gerrit](https://www.gerritcodereview.com/) is an open-source, web-based code
  review system developed by Google. It's used by major projects like Android,
  Chromium, and Go. Unlike GitHub's Pull Requests, Gerrit uses **Change Lists
  (CLs)** pushed to special `refs/for/*` references. See the
  [Glossary](/reference/glossary/#gerrit) for more details.
</Aside>
