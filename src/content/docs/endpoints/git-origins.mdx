...
<Aside type="note">
`git.github_origin` provides access to GitHub-specific metadata like PR labels, review status, and issue references.
</Aside>
...
<Aside type="caution">
Submodule processing can significantly increase sync time for repositories with many submodules.
</Aside>
...
- [Git destinations](/copybara-docs/endpoints/git-destinations/)
