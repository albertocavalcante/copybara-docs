...
<Aside type="tip">
Use `folder.destination()` during development to preview what Copybara would produce without actually pushing anywhere.
</Aside>
...
See [Authentication guide](/copybara-docs/cicd/authentication/) for details on:
...
- [Git origins in detail](/copybara-docs/endpoints/git-origins/)
- [Git destinations in detail](/copybara-docs/endpoints/git-destinations/)
