...
description: Comprehensive documentation for Google Copybara - transform and move code between repositories
template: splash
hero:
  tagline: Transform and sync code between repositories with powerful configuration
  image:
