...
<Aside type="tip">
SQUASH is the safest mode - it handles edge cases like merge commits gracefully.
</Aside>
...
<Aside type="caution">
ITERATIVE mode may fail on complex histories with merges. Consider SQUASH if you encounter issues.
</Aside>
...
<Aside type="note">
See [CHANGE_REQUEST deep dive](/copybara-docs/workflows/change-request/) for complete documentation.
</Aside>
...
- [CHANGE_REQUEST in depth](/copybara-docs/workflows/change-request/)
- [SQUASH vs ITERATIVE comparison](/copybara-docs/workflows/squash-vs-iterative/)
- [GitHub PR destination](/copybara-docs/endpoints/github/)
