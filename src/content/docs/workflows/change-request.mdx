...
CHANGE_REQUEST mode creates pull requests (GitHub), merge requests (GitLab), or change lists (Gerrit) instead of pushing directly to a branch. This is essential when:
...
- Organization policy requires review-based workflows
...
<Aside type="caution" title="Experimental">
  GitLab Merge Request support is experimental and the API may change.
</Aside>
...
core.workflow(
    ...
    destination = git.gitlab_mr_destination(
        url = "https://gitlab.com/org/dest-repo",
...
### GitLab MR Parameters

| Parameter       | Description                | Example                                      |
| --------------- | -------------------------- | -------------------------------------------- |
| `url`           | GitLab repository URL      | `https://gitlab.com/org/repo`                |
| `credentials`   | Authentication credentials | See [GitLab Integration](/endpoints/gitlab/) |
| `target_branch` | Target branch for MR       | `main`                                       |
| `source_branch` | Branch name for the MR     | `copybara/sync-${CONTEXT_REFERENCE}`         |
| `title`         | MR title                   | `Sync from internal`                         |
| `body`          | MR description             | `Automated sync...`                          |
...
- [GitHub integration](/endpoints/github/) - PR destinations and API
- [GitLab integration](/endpoints/gitlab/) - MR destinations (experimental)
- [Gerrit integration](/endpoints/gerrit/) - CL destinations
