...
<Aside type="tip">
Start with `SQUASH` mode - it's the simplest and handles edge cases well. Move to other modes only when you have specific requirements.
</Aside>
...
<Aside type="caution">
If a file exists in the destination but is not in `destination_files`, Copybara will not touch it - even if the origin has that file.
</Aside>
...
- [Workflow modes in detail](/copybara-docs/workflows/modes/)
- [CHANGE_REQUEST for PR-based workflows](/copybara-docs/workflows/change-request/)
- [SQUASH vs ITERATIVE](/copybara-docs/workflows/squash-vs-iterative/)
